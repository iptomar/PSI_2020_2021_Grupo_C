...
#   Select English Language
    ...
    time.sleep(1)
#   Go to Create History Page 
    pyautogui.click(476, 241)
    time.sleep(5)
    
#   Scroll down to see whole map
    pyautogui.scroll(-200)    
    time.sleep(2)
    
#   Click somewhere on map
    pyautogui.moveTo(randint(95, 1453), randint(250, 805))
    pyautogui.click()
    time.sleep(1)
    
#   Fill Title
    pyautogui.click(45, 260)
    pyautogui.scroll(-600)
    time.sleep(1)
    pyautogui.click(250, 350)
    time.sleep(1)
    myTitle=trim(gerarFrase(randint(5,20)))
    pyautogui.write(myTitle, interval=0.01)
    time.sleep(1)
    
#   Fill Description
    pyautogui.click(125, 450)
    time.sleep(1)
    myDescription=trim(gerarFrase(randint(50,200)))
    pyautogui.write(myDescription, interval=0.01)
    time.sleep(1)
    pyautogui.scroll(-700)
    time.sleep(1)
    
#   Fill Name Area
    pyautogui.click(150, 450)
    time.sleep(1)
    pyautogui.write("Bilal Ulutas", interval=0.01)
    time.sleep(1)
    
#   Pick Random Date
    pyautogui.moveTo(1453, 595)
    pyautogui.click()
    time.sleep(1)
    pyautogui.moveTo(randint(121, 276), randint(386, 498))
    pyautogui.click()
    time.sleep(1)
    
#   Fill Email Area
    pyautogui.click(150, 720)
    time.sleep(1)
    pyautogui.write("bilal.ulutas", interval=0.01)
    ...
    time.sleep(1)
#   Create History    
    pyautogui.click(190, 810)
    time.sleep(3)
    memoria.append([myTitle, myDescription])
    print("History " + str(i+1) + " created")
